...
**Steps**
1. Review `.d-spec/project.md`, run `d-spec list`, and inspect related code or docs (e.g., via `rg`/`ls`) to ground the proposal in current behaviour; note any gaps that require clarification.
