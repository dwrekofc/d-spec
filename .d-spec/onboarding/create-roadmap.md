# Creating / Updating a Roadmap

Use this when the user wants a phased plan across multiple ideas or capabilities.
...
- Near-term outcome (next milestone)
- Phase boundaries (what defines done for Phase 1)
- Dependencies between ideas
- Risk reducers (spikes, prototypes, validation)
